...
import { InstagramContactDialog } from "./instagram-contact-dialog";

type LeadFormProps = {
  instagramContactDialog?: boolean;
  locale?: "ko" | "en";
};
...
export function LeadForm({ instagramContactDialog = false, locale = "ko" }: LeadFormProps) {
  ...
  return (
    <InstagramContactDialog enabled={instagramContactDialog} locale={locale}>
