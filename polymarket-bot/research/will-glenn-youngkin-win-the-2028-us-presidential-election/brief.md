...
- Slug: `will-glenn-youngkin-win-the-2028-us-presidential-election`
- Category: `World Elections`
- YES ask: `0.9990`
- NO ask: `0.9990`
- Liquidity: `$1,324,924`
- Volume: `$232,277`
- Hours to close: `23276.2`
...
- No manual fair-value signal exists yet, so this stays on the review list.
- Spread 99.8c is wider than the 6.0c limit.
