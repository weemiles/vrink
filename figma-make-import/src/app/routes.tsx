      ...
      /* ═══════ 인증 필요 영역 (/app/*) — AuthGuard ═══════ */
      {
        ...
        children: [
          ...
          },
          {
            path: 'network',
            lazy: async () => {
              const { NetworkMapPage } = await import('./pages/NetworkMapPage');
              return { Component: NetworkMapPage };
            },
          },
          {
            path: 'import',
          ...
          },
          {
            path: 'timeline',
            lazy: async () => {
              const { ActivityTimelinePage } = await import('./pages/ActivityTimelinePage');
              return { Component: ActivityTimelinePage };
            },
          },
          {
            path: 'faq',
