...
import {
  ...
  Users, Clock, ArrowRight, MessageSquare, GitGraph,
} from 'lucide-react';
...
/* 3D 아이콘 이미지 */
import personIcon3D from "figma:asset/24ad3e09c31fc3adc23cdc38ca6306a3c4aacc7b.png";
import networkIcon3D from "figma:asset/07544c11520718b7c584d0532129557f3870e4e5.png";
import phoneIcon3D from "figma:asset/ee0517f2109ad677a122e3ee999995a8e8c60c2a.png";
import giftIcon3D from "figma:asset/53d775e7fc7b6422683fe2d3018781c32a068742.png";
  ...
  return (
    <div className="pb-20 bg-toss-bg">
      ...
      <div style={{ padding: `0 ${PX}px`, marginBottom: 24 }}>
        ...
        >
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center" style={{ width: 40, height: 40, borderRadius: 12, backgroundColor: 'var(--toss-grey-100)' }}>
              <GitGraph size={20} className="text-toss-grey-600" />
            </div>
            <div className="text-left">
              <span className="text-toss-grey-900 block" style={{ ...TYPO.t6, fontWeight: W.semibold }}>
                {lang === 'en' ? 'Network Map' : '인맥 지도'}
              </span>
              <span className="text-toss-grey-500" style={TYPO.s12}>
                {lang === 'en' ? 'Visualize your connections' : '내 인연 한눈에 보기'}
              </span>
            </div>
          </div>
          <ArrowRight size={16} className="text-toss-grey-300" />
        ...
        >
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center" style={{ width: 40, height: 40, borderRadius: 12, backgroundColor: 'var(--toss-grey-100)' }}>
              <Clock size={20} className="text-toss-grey-600" />
            </div>
            <div className="text-left">
              <span className="text-toss-grey-900 block" style={{ ...TYPO.t6, fontWeight: W.semibold }}>
                {lang === 'en' ? 'Activity Timeline' : '활동 타임라인'}
              </span>
              <span className="text-toss-grey-500" style={TYPO.s12}>
                {lang === 'en' ? 'All interactions at a glance' : '교류 기록 한눈에 보기'}
              </span>
            </div>
          </div>
          <ArrowRight size={16} className="text-toss-grey-300" />
